...
<div class="container">
    ...
    <form action="security/do/login.html" method="post" class="form-signin" role="form">
        ...
        <%--<p>${requestScope.excepion.message}</p>--%>
        ...
        <div class="form-group has-success has-feedback">
            <input type="text" name="userPswd" value="123" class="form-control" id="inputSuccess4" placeholder="请输入登录密码" style="margin-top:10px;">
